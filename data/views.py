...
# Verknüpfte Tabellen
def add_model_instance_ajax(request, form_class, redirect_name):
    if request.method == 'POST':
...
def add_lagerort_ajax(request):
    return add_model_instance_ajax(request, LagerortForm, 'add-explants')

def add_patient_ajax(request):
    return add_model_instance_ajax(request, PatientForm, 'add-explants')

def add_reoperation_ajax(request):
    return add_model_instance_ajax(request, ReoperationForm, 'add-explants')

def add_inlay_ajax(request):
    return add_model_instance_ajax(request, InlayForm, 'add-explants')

def add_kopf_ajax(request):
    return add_model_instance_ajax(request, KopfForm, 'add-explants')

def add_schaft_ajax(request):
    return add_model_instance_ajax(request, SchaftForm, 'add-explants')

def add_pfanne_ajax(request):
    return add_model_instance_ajax(request, PfanneForm, 'add-explants')

def add_femurkomponente_ajax(request):
    return add_model_instance_ajax(request, FemurkomponenteForm, 'add-explants')

def add_tibiaplateau_ajax(request):
    return add_model_instance_ajax(request, TibiaplateauForm, 'add-explants')

def add_patellaersatz_ajax(request):
    return add_model_instance_ajax(request, PatellaersatzForm, 'add-explants')
